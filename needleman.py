...
def write_outputs(align1, align2, sym):
    with open("outputs.txt", "w", encoding="utf-8"):
        file.write(align1)
        file.write(align2)
        file.write(sym)
...
def needle(s1, s2):
    ...
    print(sym)
    print(align2)
    write_outputs(align1, align2, sym)


if __name__ == '__main__':
    covid = ""
    sars = ""
    with open("nCovid.txt", "r", encoding="utf-8") as file:
        covid = file.read()

    with open("SARS.txt", "r", encoding="utf-8") as file:
        sars = file.read()
